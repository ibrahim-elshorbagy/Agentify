...
export default function BinTable({ emails, queryParams }) {
  ...
  const columns = [
    ...
    { field: 'status', label: t('status'), icon: 'fa-trash' },
    ...
    <>
      ...
      <td className="px-6 py-4 whitespace-nowrap opacity-75">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-neutral-900 dark:text-neutral-100 truncate max-w-xs line-through">
            {email.subject}
          </span>
        </div>
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
        <div className="flex items-center gap-2">
          ...
          {email.is_starred && (
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300 opacity-50">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-500 dark:text-neutral-400 opacity-75">
