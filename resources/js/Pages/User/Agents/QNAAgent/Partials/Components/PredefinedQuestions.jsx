  ...
  return (
    <div className="flex flex-wrap gap-3 mb-6">
      {predefinedQuestions.map((question, index) => (
        ...
        >
          <i className="fa-solid fa-magic-wand-sparkles text-sm mr-3 text-green-500 dark:text-green-400 group-hover:text-green-600 dark:group-hover:text-green-300 transition-colors duration-200"></i>
