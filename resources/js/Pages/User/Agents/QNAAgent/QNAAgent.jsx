...
export default function QNAAgent({
  ...
  return (
    <AppLayout>
      ...
      <div className="min-h-full flex bg-gradient-to-br from-green-50 via-emerald-50 to-teal-100 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 overflow-hidden relative"
           style={{
             backgroundImage: `
        ...
        {/* Main Chat Area */}
        <div className={`flex-1 flex flex-col min-h-full overflow-hidden ${isSidebarOpen ? 'xl:ml-0' : ''}`}>
          <ChatInterface
            currentConversation={currentConversation}
            messages={messages}
            onEditConversation={toggleEditConversationModal}
