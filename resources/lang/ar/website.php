...
return [
  ...
  */
  ...
  'file_agent' => 'وكيل الملفات',
  'chatbot_agent' => 'وكيل الدردشة',
  'hiring_agent' => 'وكيل التوظيف',
  'ai_powered_platform' => 'منصة مدعومة بالذكاء الاصطناعي',
  'language' => 'اللغة',
  'english' => 'الإنجليزية',
  'arabic' => 'العربية',
  ...
  'boost_business_efficiency_ai' => 'عزّز كفاءة أعمالك بالذكاء الاصطناعي',
  'take_control_email_files_hiring' => 'تحكّم في بريدك، ملفاتك، وعمليات التوظيف خلال ثوانٍ  منصة واحدة تجمع كل وكلاء الذكاء الاصطناعي الذين تحتاجهم لإنجاز الأعمال أسرع وبأعلى جودة.',
  ...
  'fetch_latest_email' => 'جلب أحدث بريد إلكتروني',
  'close' => 'إغلاق',
  ...
  'server_time_info' => 'معلومات وقت الموقع',
  'current_server_time' => 'وقت الموقع الحالي',
  'server_timezone' => 'المنطقة الزمنية للموقع',
  'schedule_times_based_on_server' => 'جميع الأوقات المجدولة تعتمد على المنطقة الزمنية للموقع. يرجى ضبط الأوقات وفقاً لهذه المنطقة الزمنية.',

  // Subscription translations
  'subscription' => 'الاشتراك',
  'my_subscription' => 'اشتراكي',
  'manage_your_subscription_and_usage' => 'إدارة اشتراكك ومراقبة استخدام الميزات',
  'no_active_subscription' => 'لا يوجد اشتراك نشط',
  'subscribe_to_plan_to_access_features' => 'اشترك في خطة للوصول إلى جميع الميزات',
  'feature_usage' => 'استخدام الميزات',
  'start_date' => 'تاريخ البداية',
  'end_date' => 'تاريخ النهاية',
  'next_reset' => 'التحديث التالي',
  'status' => 'الحالة',
  'used' => 'مستخدم',
  'limit' => 'الحد',
  'unlimited' => 'غير محدود',
  'resets_on' => 'يعيد التعيين في',
  'monthly' => 'شهري',
  'yearly' => 'سنوي',
  ...
  'agent_features_description' => 'تتبع استخدامك عبر جميع الميزات',
  ...
  'privacy_policy_intro' => 'في Agentify، نحن ملتزمون بحماية خصوصيتك وضمان التعامل مع معلوماتك الشخصية بأقصى درجات العناية. توضح سياسة الخصوصية هذه كيفية جمعنا واستخدامنا وكشفنا وحماية معلوماتك عند زيارة موقعنا الإلكتروني واستخدام خدماتنا. بالوصول إلى موقعنا أو استخدامه، توافق على شروط سياسة الخصوصية هذه.',
  'privacy_policy_section_1_title' => '1. المعلومات التي نجمعها',
  'privacy_policy_section_1_content' => 'نجمع أنواعًا مختلفة من المعلومات لتقديم وتحسين خدماتنا، بما في ذلك: المعلومات الشخصية: الاسم وعنوان البريد الإلكتروني وتفاصيل الحساب. معلومات الاستخدام: معلومات حول كيفية استخدامك لمنصتنا، بما في ذلك التفاعلات مع وكلاء الذكاء الاصطناعي. بيانات البريد الإلكتروني: عند ربط حسابات Gmail أو Outlook الخاصة بك، نصل إلى رسائل البريد الإلكتروني الخاصة بك لتقديم خدمات مثل تصنيف البريد الإلكتروني والاقتراحات وجمع السير الذاتية. نحن نعالج فقط بيانات البريد الإلكتروني الضرورية بشكل آمن. المعلومات التقنية: عنوان IP ونوع المتصفح ومعلومات الجهاز.',  'privacy_policy_section_2_title' => '2. كيف نستخدم معلوماتك',
  'privacy_policy_section_2_content' => 'نستخدم معلوماتك لأغراض مختلفة، بما في ذلك: تقديم الخدمة: لتقديم خدمات وكلاء الذكاء الاصطناعي ومعالجة طلباتك. إدارة الحساب: لإنشاء وإدارة حسابك. التحسين: لتحليل وتحسين خدماتنا. الامتثال القانوني: للامتثال للالتزامات القانونية.',
  'privacy_policy_section_3_title' => '3. كيف نشارك معلوماتك',
  'privacy_policy_section_3_content' => 'لا نبيع أو نؤجر معلوماتك الشخصية لأطراف ثالثة. قد نشارك معلوماتك فقط في ظروف ضرورية عندما يتطلب القانون ذلك.',
  'privacy_policy_section_4_title' => '4. أمان البيانات',
  'privacy_policy_section_4_content' => 'نطبق تدابير فنية وتنظيمية مناسبة لحماية معلوماتك الشخصية. ومع ذلك، لا يمكن ضمان أن يكون أي نقل بيانات عبر الإنترنت آمنًا بنسبة 100%.',
  'privacy_policy_section_5_title' => '5. حقوقك',
  'privacy_policy_section_5_content' => 'لديك الحق في الوصول إلى تحديث أو حذف معلوماتك الشخصية. اتصل بنا على support@agentifysa.com لأي استفسارات متعلقة بالخصوصية.',
  'privacy_policy_contact' => 'إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا على support@agentifysa.com',

  // Terms of Service
  'terms_title' => 'شروط الخدمة',
  'terms_intro' => 'مرحباً بك في Agentify. تحكم شروط الخدمة هذه استخدامك لمنصتنا ووكلاء الذكاء الاصطناعي. بالوصول إلى خدماتنا أو استخدامها، توافق على هذه الشروط.',
  'terms_section_1_title' => '1. قبول الشروط',
  'terms_section_1_content' => 'باستخدام Agentify، تقبل وتوافق على الالتزام بشروط الخدمة هذه.',
  'terms_section_2_title' => '2. وصف الخدمة',
  'terms_section_2_content' => 'يوفر Agentify وكلاء مدعومين بالذكاء الاصطناعي لإدارة البريد الإلكتروني وتحليل التقارير والمهام المتعلقة بالموارد البشرية. لاستخدام وكيل البريد الإلكتروني ووكيل الموارد البشرية، تمنحنا الوصول إلى حسابات Gmail أو Outlook الخاصة بك لقراءة ومعالجة رسائل البريد الإلكتروني. يُستخدم هذا الوصول فقط لتقديم خدماتنا ويتم التعامل معه بشكل آمن. الخدمات عرضة للتوافر وقد تتغير.',
  'terms_section_3_title' => '3. مسؤوليات المستخدم',
  'terms_section_3_content' => 'أنت مسؤول عن الحفاظ على سرية حسابك وجميع الأنشطة تحت حسابك. توافق على عدم إساءة استخدام خدماتنا.',
  'terms_section_4_title' => '4. الخصوصية',
  'terms_section_4_content' => 'خصوصيتك مهمة بالنسبة لنا. يرجى مراجعة سياسة الخصوصية الخاصة بنا للحصول على تفاصيل حول كيفية جمعنا واستخدام معلوماتك.',
  'terms_section_5_title' => '5. تحديد المسؤولية',
  'terms_section_5_content' => 'لن تكون Agentify مسؤولة عن أي أضرار غير مباشرة أو عرضية أو تبعية تنشأ من استخدامك لخدماتنا.',
  'terms_contact' => 'للأسئلة حول هذه الشروط، اتصل بنا على support@agentifysa.com',
];
