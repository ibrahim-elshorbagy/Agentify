...
class ReportAgentChatService
{
  ...
  {
    $this->chatWebhookUrl = config('services.report_agent_chat.webhook_url');
    $this->jwtSecret = config('services.report_agent_chat.jwt_secret');
  }
  ...
  public function sendMessage(array $data = []): array
  {
    try {
      ...
      if ($response->successful()) {
        ...
        Log::error('ReportAgentChatService: Chat webhook failed', [
          'status_code' => $response->status(),
      ...
      Log::error('ReportAgentChatService: Chat webhook exception', [
        'error' => $e->getMessage(),
