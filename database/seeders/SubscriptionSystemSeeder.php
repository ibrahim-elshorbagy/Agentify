    ...
    public function run()
    {
        ...
        $features = [
            ...
            [
                ...
                'description' => ['en' => 'Number of clicks to fetch CVs from Gmail or Outlook per month', 'ar' => 'عدد النقرات لجلب السير الذاتية من Gmail أو Outlook شهرياً'],
            ],
            ...
            [
                ...
                'description' => ['en' => 'Number of email fetches from Gmail or Outlook per month', 'ar' => 'عدد مرات جلب البريد من Gmail أو Outlook شهرياً'],
            ],
            [
                'id' => 7,
                'key' => 'email_agent',
        ...
        $planLimits = [
            // Basic Plan
            'Basic' => [
                1 => 10,     // Upload CV per month
                2 => 5,      // Fetch from email box per month
                3 => 5,      // Files per month
                4 => 5,      // Max file size (MB)
                5 => 20,     // Reports messages per month
                6 => 10,     // Email fetches per month
                7 => 20,     // Email messages per month (Agent + QNA)
            ],

            // Starter Plan
            'Starter' => [
                1 => 30,     // Upload CV per month
                2 => 15,     // Fetch from email box per month
                3 => 15,     // Files per month
                4 => 15,     // Max file size (MB)
                5 => 50,     // Reports messages per month
                6 => 30,     // Email fetches per month
                7 => 50,     // Email messages per month (Agent + QNA)
            ],

            // Pro Plan
            'Pro' => [
                1 => 75,     // Upload CV per month
                2 => 40,     // Fetch from email box per month
                3 => 40,     // Files per month
                4 => 30,     // Max file size (MB)
                5 => 150,    // Reports messages per month
                6 => 75,     // Email fetches per month
                7 => 150,    // Email messages per month (Agent + QNA)
            ],

            // Business Plan
            'Business' => [
                1 => 200,    // Upload CV per month
                2 => 100,    // Fetch from email box per month
                3 => 100,    // Files per month
                4 => 50,     // Max file size (MB)
                5 => 500,    // Reports messages per month
                6 => 200,    // Email fetches per month
                7 => 500,    // Email messages per month (Agent + QNA)
            ],
        ];
